...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    ...
    <h5>
     ...
     <asp:Label ID="Label5" runat="server" Text=""></asp:Label>&nbsp; &nbsp;&nbsp; <asp:Label ID="Label10" runat="server" Text=""></asp:Label>&nbsp; &nbsp;&nbsp;<br /> 
...
&nbsp;&nbsp;
  ...
  <asp:Label ID="Label2" runat="server" Text=""></asp:Label>
    ...
    <br />
    <br />
    <asp:Label ID="Label7" runat="server" Text=""></asp:Label> <asp:Label ID="Label9" runat="server" Text=""></asp:Label>
    </div>
</asp:Content>
